...
print("Unfortunately I only have space for two.")

one = people.pop()
print("Sorry for the inconvenience, " + one + ".")
two = people.pop()
print("Sorry for the inconvenience, " + two + ".")
three = people.pop()
print("Sorry for the inconvenience, " + three + ".")
four = people.pop()
print("Sorry for the inconvenience, " + four + ".")
five = people.pop()
print("Sorry for the inconvenience, " + five + ".")
